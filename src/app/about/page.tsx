  ...
  return (
    <div className="bg-museum-bg min-h-screen pt-24">
      <section className="max-w-3xl mx-auto px-5 sm:px-8 lg:px-10 pb-24">
        ...
        <p className="text-white/45 mb-14">关于本博物馆</p>
        ...
        <div className="space-y-16 text-white/70">
          ...
          <div>
            ...
            <p className="leading-relaxed text-white/50 mt-6">
              女性理工先驱博物馆是一个数字展览，致力于展现女性在科学、技术、工程与数学领域中的非凡贡献。
            </p>
            <p className="leading-relaxed text-white/50 mt-4">
          ...
          <div>
            ...
            <p className="mt-6">
              <span className="text-sm tracking-[0.15em] uppercase text-white/55">Email</span>
              <br />
              <a
            ...
            <p className="leading-relaxed text-white/50 mt-8">
            ...
            <p className="text-white/50 mt-4">
              <span className="text-sm tracking-[0.15em] uppercase text-white/55">邮箱</span>
              <br />
              <a
                href="mailto:Amarisher@outlook.com"
